function out_C=Des(u)   %DES算法
%   输入u为64位明/密文+64位密钥+1位模式位
D = u(1:64);  %64位明/密文
K = u(65:128);  %64位密钥
M = u(129);   %模式位
...
for i=1:16
    ...
    C1= double2bin(S1(x,y),4);
    %经S2盒
    B=R_Ki(7:12);
    x=B(1)*2+B(6)+1;
    y=B(2)*8+B(3)*4+B(4)*2+B(5)+1;
    C2= double2bin(S2(x,y),4);
    %经S3盒
    B=R_Ki(13:18);
    x=B(1)*2+B(6)+1;
    y=B(2)*8+B(3)*4+B(4)*2+B(5)+1;
    C3= double2bin(S3(x,y),4);
    %经S4盒
    B=R_Ki(19:24);
    x=B(1)*2+B(6)+1;
    y=B(2)*8+B(3)*4+B(4)*2+B(5)+1;
    C4= double2bin(S4(x,y),4);
    %经S5盒
    B=R_Ki(25:30);
    x=B(1)*2+B(6)+1;
    y=B(2)*8+B(3)*4+B(4)*2+B(5)+1;
    C5= double2bin(S5(x,y),4);
    %经S6盒
    B=R_Ki(31:36);
    x=B(1)*2+B(6)+1;
    y=B(2)*8+B(3)*4+B(4)*2+B(5)+1;
    C6= double2bin(S6(x,y),4);
    %经S7盒
    B=R_Ki(37:42);
    x=B(1)*2+B(6)+1;
    y=B(2)*8+B(3)*4+B(4)*2+B(5)+1;
    C7= double2bin(S7(x,y),4);
    %经S8盒
    B=R_Ki(43:48);
    x=B(1)*2+B(6)+1;
    y=B(2)*8+B(3)*4+B(4)*2+B(5)+1;
    C8= double2bin(S8(x,y),4);
